...
class Apertura():
	def __init__(self,texto):
		...
		self.boton = Button(text="Leer archivo",command = lambda:(controladorValida.validar(texto),controladorValida.leerArchivo(texto.get()),controladorValida.Valida(self.miframe)))
